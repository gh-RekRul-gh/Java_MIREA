    ...
    public LabClassUI(ArrayList<Student> students) {
        ...
        infAddButton.addActionListener(e -> {
            JOptionPane.showMessageDialog(this,
                    "For adding student enter name, age, GPA");
        });
        infDeleteButton.addActionListener(e -> {
            JOptionPane.showMessageDialog(this,
                    "For removing student enter his name");
        });
        infSearchButton.addActionListener(e -> {
            JOptionPane.showMessageDialog(this,
                    "To search for a student enter his name");
        });
        ...
        addButton.addActionListener(e -> {
            ...
            if (Objects.equals(infStudent, ""))
                ...
                try {
                    student = new Student(information[0], Integer.parseInt(information[1]), Double.parseDouble(information[2]));
